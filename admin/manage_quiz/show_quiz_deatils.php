 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top position-relative">  <!--  postion relative to align the tab content  -->
  <a class="navbar-brand text-white" href="../index.php">Edu me</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      ...
      <li class="nav-item active">
        <a class="nav-link text-white" href="manage_quiz.php">Back <span class="sr-only">(current)</span></a>
      </li>
      <!-- <li class="nav-item">
...
<?php 
 ...
 <table class="table table-hover table-bordered table-active">
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" > <?php echo $quest['opt1']; ?></td>
    </tr>
	<?php } ?>
	<?php if (isset($quest['opt2'])){ ?>
      <tr>
      <td scope="row"><?php echo $quest['opt2']; ?></td>
    </tr>
    <?php } ?>
    <?php if (isset($quest['opt3'])){ ?>
    <tr>
      <td scope="row"> <?php echo $quest['opt3']; ?></td>
    </tr>
    <?php } ?>
    <?php if (isset($quest['opt4'])){ ?>
    <tr>
      <td scope="row"><?php echo $quest['opt4']; ?></td>
    </tr>
     <?php } ?>
    <tr>
    <td scope="row"><?php echo "Answer is: ",$quest['answer']+1; ?></td>
    </tr>
      <tr>
	...
	<a href="manage_quiz.php"><span class="btn btn-success">Back</span></a> 
</form>
</div>
